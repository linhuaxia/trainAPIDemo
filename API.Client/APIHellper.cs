...
namespace API.Client
{
    public class APIHellper
    {
        public static class ConstConfig
        {
            ...
            /// api服务器地址
            /// </summary>
            public static readonly string APIURL = "http://trainapitest.gzlfxx.cn/api";
            //public static readonly string APIURL = "http://trainapi.gzlfxx.cn/api";
        ...
        public static string GetAPI(string URL, string KeyName)
        {
            ...
            string url = ConstConfig.APIURL + "/" + URL.TrimStart('/');
